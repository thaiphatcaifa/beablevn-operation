    ...
    return (
        <div className="task-card" style={{ 
            ...
            <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap: '12px'}}>
                <h3 style={{margin:0, color: '#111827', fontSize: '1.15rem', fontWeight: '800', lineHeight: '1.4', letterSpacing: '-0.01em'}}>{task.title}</h3>
            ...
            {isOverdue && (
                <div style={{color: '#b91c1c', fontWeight: '700', fontSize:'0.85rem', marginTop: '16px', background:'#fef2f2', padding:'12px 16px', borderRadius:'10px', display: 'flex', alignItems: 'center', gap: '8px', border: '1px solid #fecaca'}}>
            ...
            {task.description && (
                <p style={{fontSize: '0.9rem', color:'#64748b', background:'#f8fafc', padding:'16px', borderRadius:'12px', fontStyle:'italic', border: '1px dashed #cbd5e1', marginTop: '16px', lineHeight: '1.5', margin: '16px 0 0 0'}}>
                    {task.description}
                </p>
            )}
            ...
            <label style={{fontSize: '0.95rem', fontWeight: '800', color: '#111827', display: 'flex', justifyContent: 'space-between'}}>
                Tiến độ công việc: 
                ...
                <div style={{background:'#f8fafc', padding:'20px', borderRadius:'16px', border: '1px solid #f1f5f9'}}>
                    ...
                    {(progressInput < 90) && (
                        <div style={{marginTop:'16px'}}>
                            <div style={{color:'#d97706', fontSize:'0.85rem', marginBottom:'8px', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '6px'}}>
                    ...
                    <div style={{display:'flex', gap:'12px', marginTop:'24px', flexWrap: 'wrap'}}>
                        <button className="btn-modern-primary" onClick={handleUpdate} style={{flex:1, background:'#003366', color:'white', padding:'14px', border:'none', borderRadius:'10px', cursor:'pointer', fontWeight:'700', fontSize: '0.95rem', boxShadow: '0 4px 6px rgba(0, 51, 102, 0.2)', minWidth: '140px'}}>
                            Lưu cập nhật
                        </button>
                        <button className="btn-modern-success" onClick={() => onFinish(task)} style={{flex:1, background:'#10b981', color:'white', padding:'14px', border:'none', borderRadius:'10px', cursor:'pointer', fontWeight:'700', fontSize: '0.95rem', boxShadow: '0 4px 6px rgba(16, 185, 129, 0.2)', minWidth: '140px'}}>
                            Kết thúc ngay
                        </button>
                    </div>
                </div>
...
const MyTasks = () => {
  ...
  return (
    <div style={{paddingBottom: '40px', boxSizing: 'border-box'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '32px', borderBottom: '2px solid #e5e7eb', paddingBottom: '16px' }}>
